...
export default function FloatingWhatsApp() {
  return (
    <div className="fixed bottom-20 sm:bottom-6 right-4 sm:right-6 z-50 group flex items-center gap-3 transition-all duration-300">
      {/* Hover Tooltip Badge */}
      ...
      <a
        ...
        className="relative bg-[#25D366] hover:bg-[#20ba5a] text-white p-3.5 sm:p-4 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 active:scale-95 animate-pulse-glow flex items-center justify-center"
        target="_blank"
