/**
 * MASTER PRODUCT CATALOG — Gorgeous Furniture Ethiopia
 * Single source of truth for all products across all pages.
 * Used by category pages AND the wishlist page to ensure IDs always match.
 */
...
export const TV_PRODUCTS = [
  {
    ...
    category: 'TV Units',
    href: '/tv-stand',
    description: 'White marble top media unit with soft-closing drawers and gold stainless trim.',
  },
  {
    ...
    href: '/tv-stand',
    description: 'Set of 2 nesting round tables with sintered stone top and champagne gold base.',
  },
  {
    ...
    category: 'TV Units',
    href: '/tv-stand',
    description: 'Tambour door fluted wood TV unit with cable management ports.',
  },
  {
    ...
    category: 'Coffee Tables',
    href: '/tv-stand',
    description: 'Heavy-duty tempered glass shelf with architectural geometric brass frame.',
  },
];
